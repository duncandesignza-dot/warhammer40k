...
test("new army pages show the faction's picture under the army name, where there is one", async ({page}) => {
  await seed(page);
  for(const f of ["adepta-sororitas", "adeptus-custodes", "adeptus-mechanicus", "agents-of-the-imperium", "astra-militarum", "black-templars", "blood-angels", "dark-angels", "deathwatch", "grey-knights", "imperial-fists", "imperial-knights", "iron-hands", "raven-guard", "salamanders", "space-wolves", "white-scars"]){
