...
-- OPTIONAL: let anyone with a link view ledgers (read only).
-- Remove the two dashes at the start of both lines to turn it on.
-- create policy "armies: public read" on public.armies for select to anon, authenticated using (true);
